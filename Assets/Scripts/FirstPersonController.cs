...
namespace StarterAssets
{
	...
	public class FirstPersonController : MonoBehaviour
	{
		...
		private void Update()
		{
			...
			GroundedCheck();
			Move();
			// // Get user input (replace with your own input method).
        	// float horizontalInput = Input.GetAxis("Horizontal");
        
        	// // Calculate the desired Z rotation for leaning.
        	// float leanRotation = horizontalInput * leanAngle;
            ...
            // 	if (LeaningLeft) {
			// 		LeaningRight = false;
            //     	StartCoroutine(LeanLeft(leanRotation));
            // 	} else {
			// 		CancelLean();
			// 	}
        	// }
            ...
            // 	if (LeaningRight) {
			// 		LeaningLeft = false;
            //     	StartCoroutine(LeanRight(leanRotation));
            // 	} else {
			// 		CancelLean();
			// 	}	
        	//}
		...
		// IEnumerator LeanLeft(float zRotation) 
		// {
		...
		// IEnumerator LeanRight(float zRotation) 
		// {
		// 	yield return new WaitForSeconds(0f);
